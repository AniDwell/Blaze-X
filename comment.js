...
window.app.initDraggableSheet = () => {
    ...
    const dragEnd = () => {
        ...
        if (currentVh > 70) { window.app.state.commentHeight = 90; panel.style.height = `90vh`; } 
        else if (currentVh > 25) { window.app.state.commentHeight = 50; panel.style.height = `50vh`; } 
        else { window.app.closeComments(); }
    };
