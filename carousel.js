...
window.app.components.carousel = async () => {
    ...
    try {
            ...
            slidesHtml += `
                <div class="carousel-slide absolute inset-0" id="slide-${i}" style="opacity: ${i === 0 ? '1' : '0'}; z-index: ${i === 0 ? '20' : '10'}; transition: opacity 1.5s ease-in-out;">
                    ...
                    <div class="absolute inset-0 cursor-pointer z-0 group" onclick="window.location.href='info.html?id=${id}'">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/30 to-transparent md:w-1/2"></div>
                    </div>
                    
                    <div class="absolute bottom-8 left-4 md:bottom-12 md:left-12 z-30 max-w-[90%] md:max-w-2xl pr-8">
                        ${ratingHtml}
        ...
        // Restored Taller Aspect Ratio: aspect-[4/5] on mobile
        container.innerHTML = `
