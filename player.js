...
window.app.components.player = async () => {
    ...
    const episodeId = urlParams.get('id'); // Fix: Fetch stream using episode ID
                ...
                <div id="ui-layer" class="player-ui-layer absolute inset-0 z-30 flex flex-col justify-between bg-gradient-to-t from-black/95 via-transparent to-black/80 pointer-events-none">
                    ...
                    <div class="w-full flex items-start justify-between p-4 md:p-6 pointer-events-auto">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button id="open-settings-btn" class="w-10 h-10 rounded-full bg-black/50 border border-white/10 text-white hover:text-[#F47521] hover:border-[#F47521] transition-all duration-500 flex items-center justify-center backdrop-blur-md">
                                <i class="fas fa-cog text-lg" id="settings-icon"></i>
                            </button>
                        </div>
                    </div>
